  ...
  render() {
    return(
      ...
      {/* <nav>
        <ul>
          <li>
            <a onClick={()=>this.showModule("plot")}>Plot Summary</a>
          </li>
          <li><a onClick={()=>this.showModule("order")}>Speaking Order</a></li>
          <li><a onClick={()=>this.showModule("dialogue")}>What to Say</a></li>
          <li><a onClick={()=>this.showModule("character")}>Character</a></li>
          <li><a onClick={()=>this.showModule("clues")}>Clues</a></li>
        </ul>
      </nav> */}
